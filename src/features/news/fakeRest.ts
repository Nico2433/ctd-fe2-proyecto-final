...
const simulateTranscurredTime: (decrementMiliseconds: number) => Date = (
...
const data = [
  {
    ...
    date: simulateTranscurredTime(300000),
    isPremium: false,
    source:
  ...
  },
  {
    ...
    date: simulateTranscurredTime(1200000),
    isPremium: false,
    source:
...
export const obtainNews: () => Promise<Inews[]> = async () => {
